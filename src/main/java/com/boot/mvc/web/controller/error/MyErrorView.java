package com.boot.mvc.web.controller.error;
...
public class MyErrorView implements ErrorViewResolver {
	...
	public ModelAndView resolveErrorView(HttpServletRequest request, HttpStatus status, Map<String, Object> map) {
		...
		case 404:
			...
			model.addObject("message", "A URL para pagina' " + map.get("path") + " ' não existe !");
			break;

		case 500:
			model.addObject("error", "Ocorreu um erro interno no servidor!");
			model.addObject("message", "Ocorreu um erro interno, tente mais tarde.");
			break;
